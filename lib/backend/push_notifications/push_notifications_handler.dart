...
final parametersBuilderMap =
  ...
  'AreaUnservicablePage': ParameterData.none(),
  'Login': ParameterData.none(),
  'CreateAccount': ParameterData.none(),
  'Onboarding': ParameterData.none(),
  'productList': (data) async => ParameterData(
        allParams: {
          'selectedCategory':
              getParameter<DocumentReference>(data, 'selectedCategory'),
        },
      ),
